...
template <class ItemType>
void Find (TreeNode<ItemType>* tree) {
    if  (tree->left!=NULL)
        Find(tree->left);
    else
        cout <<tree->info ;
...
template <class ItemType>
int  num (TreeNode<ItemType>* tree) {
    if (tree==NULL)
        return 0;
    ...
    if (tree->left==NULL && tree->right==NULL)
       return 1;
        ...
        return num(tree->left)+num(tree->right);

}

template <class ItemType>
ItemType TreeType<ItemType>::findMin()
{
    int x;
